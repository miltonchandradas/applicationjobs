CLASS zcl_catalog_template DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS zcl_catalog_template IMPLEMENTATION.


  METHOD if_oo_adt_classrun~main.


    CONSTANTS lc_catalog_name      TYPE cl_apj_dt_create_content=>ty_catalog_name  VALUE 'ZPRODUCTS_CATALOG_V3'.
    CONSTANTS lc_catalog_text      TYPE cl_apj_dt_create_content=>ty_text          VALUE 'Catalog entry'.
    CONSTANTS lc_class_name        TYPE cl_apj_dt_create_content=>ty_class_name    VALUE 'ZCL_PRODUCTS_BUSINESS_LOGIC'.

    CONSTANTS lc_template_name     TYPE cl_apj_dt_create_content=>ty_template_name VALUE 'ZPRODUCTS_TEMPLATE_V3'.
    CONSTANTS lc_template_text     TYPE cl_apj_dt_create_content=>ty_text          VALUE 'Products JOB TEMPLATE V3'.

    CONSTANTS lc_transport_request TYPE cl_apj_dt_create_content=>ty_transport_request VALUE 'S4UK900500'.
    CONSTANTS lc_package           TYPE cl_apj_dt_create_content=>ty_package           VALUE 'ZABAPCLOUD_DEVELOPMENT'.
...
*    ENDTRY.
    ...
    NEW zcl_products_business_logic( )->if_apj_dt_exec_object~get_parameters(
      IMPORTING
