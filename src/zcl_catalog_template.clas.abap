...
CLASS zcl_catalog_template IMPLEMENTATION.
  ...
  METHOD if_oo_adt_classrun~main.
    ...
    CONSTANTS lc_catalog_name      TYPE cl_apj_dt_create_content=>ty_catalog_name  VALUE 'ZPRODUCTS_CATALOG_V5'.
    CONSTANTS lc_catalog_text      TYPE cl_apj_dt_create_content=>ty_text          VALUE 'PRODUCTS JOB CATALOG V5'.
    CONSTANTS lc_class_name        TYPE cl_apj_dt_create_content=>ty_class_name    VALUE 'ZCL_PRODUCTS_BUSINESS_LOGIC'.

    CONSTANTS lc_template_name     TYPE cl_apj_dt_create_content=>ty_template_name VALUE 'ZPRODUCTS_TEMPLATE_V5'.
    CONSTANTS lc_template_text     TYPE cl_apj_dt_create_content=>ty_text          VALUE 'PRODUCTS JOB TEMPLATE V5'.
