...
CLASS zcl_products_business_logic IMPLEMENTATION.
  ...
  METHOD if_apj_dt_exec_object~get_parameters.
    ...
    et_parameter_def = VALUE #( ( selname = 'P_INCREMENT' kind = if_apj_dt_exec_object=>parameter datatype = 'I' length = 10 param_text = 'My Increment Value' changeable_ind = abap_true ) ).

    " Return the default parameters values here
    et_parameter_val = VALUE #( ( selname = 'P_INCREMENT' kind = if_apj_dt_exec_object=>parameter sign = 'I' option = 'EQ' low = '1' ) ).
  ENDMETHOD.
